...
def map_callback(data):
	...
	m = np.array(data.data).reshape((height, width))  # TODO check this
	...
	draw.pose.orientation = Quaternion(0, 0, 0, 1)
	...
	for pair in nearby:
		...
		points.append(Point(res*pair[0], res*pair[1], 0))
		points.append(Point(res*pair[2], res*pair[3], 0))
